import type { AccessMode, Expression, ExpressionBuilder, Insertable, IsolationLevel, Kysely, Selectable, SelectQueryBuilder, SqlBool, Transaction, Updateable } from "kysely";
...
export type OrmfyProjection<DB, TName extends OrmfyTableName<DB>, Columns extends readonly OrmfyColumn<DB, TName>[]> = Pick<OrmfyRow<DB, TName>, Columns[number]>;
...
export type OrmfySort<DB, TName extends OrmfyTableName<DB>> = Array<[
    OrmfyColumn<DB, TName>,
    "asc" | "desc"
] | [OrmfyColumn<DB, TName>, "asc" | "desc", "first" | "last"]>;
...
export type OrmfyFindReturn<DB, TName extends OrmfyTableName<DB>, TCount extends boolean> = Array<OrmfyRow<DB, TName> & (TCount extends true ? {
    count: number;
} : unknown)>;
...
export type OrmfyMutationReturningOptions<DB, TName extends OrmfyTableName<DB>, Columns extends readonly OrmfyColumn<DB, TName>[] | undefined = undefined> = OrmfyMutationOptions<DB> & {
    returning?: Columns;
};
export type OrmfyReturningRow<DB, TName extends OrmfyTableName<DB>, Columns extends readonly OrmfyColumn<DB, TName>[] | undefined> = Columns extends readonly OrmfyColumn<DB, TName>[] ? OrmfyProjection<DB, TName, Columns> : OrmfyRow<DB, TName>;
...
export type OrmfyBase<DB, TName extends OrmfyTableName<DB>> = {
     ...
     * ```
     */
    batchInsert: (data: readonly OrmfyCreateInput<DB, TName>[], options?: {
        atomic?: boolean;
        chunkSize?: number;
        tx?: OrmfyDb<DB>;
    }) => Promise<Array<OrmfyRow<DB, TName>>>;
    /** Conta os registros que batem com o filtro. */
    countDocuments: (filter?: OrmfyFindFilter<DB, TName>, options?: {
        tx?: OrmfyDb<DB>;
    }) => Promise<number>;
    /**
     ...
     * quando omitida.
     */
    create: <Columns extends readonly OrmfyColumn<DB, TName>[] | undefined = undefined>(data: OrmfyCreateInput<DB, TName>, options?: OrmfyReturningOptions<DB, TName, Columns>) => Promise<OrmfyReturningRow<DB, TName, Columns>>;
    /** Alias para `insertMany`. */
    createMany: (data: readonly OrmfyCreateInput<DB, TName>[], options?: {
        tx?: OrmfyDb<DB>;
    }) => Promise<Array<OrmfyRow<DB, TName>>>;
    /**
     ...
     * ```
     */
    cursorPaginate: (filter: OrmfyFindFilter<DB, TName> | undefined, options: OrmfyCursorPageOptions<DB, TName>) => Promise<OrmfyCursorPage<OrmfyRow<DB, TName>>>;
    /** Decrementa uma coluna numerica por id e retorna o registro atualizado. */
    decrement: (id: OrmfyPrimaryKeyValue<DB, TName>, column: OrmfyNumericColumn<DB, TName>, amount?: number, options?: {
        tx?: OrmfyDb<DB>;
     ...
     */
    delete: <Columns extends readonly OrmfyColumn<DB, TName>[] | undefined = undefined>(filter: OrmfyFindFilter<DB, TName>, options?: OrmfyMutationReturningOptions<DB, TName, Columns>) => Promise<Array<OrmfyReturningRow<DB, TName, Columns>>>;
    /** Remove um registro pela chave primaria e retorna o registro removido. */
    deleteById: <Columns extends readonly OrmfyColumn<DB, TName>[] | undefined = undefined>(id: OrmfyPrimaryKeyValue<DB, TName>, options?: OrmfyReturningOptions<DB, TName, Columns>) => Promise<OrmfyReturningRow<DB, TName, Columns>>;
    /** Retorna true quando nenhum registro bate com o filtro. */
    doesntExist: (filter: OrmfyFindFilter<DB, TName>, options?: {
        tx?: OrmfyDb<DB>;
    }) => Promise<boolean>;
    /** Retorna true quando pelo menos um registro bate com o filtro. */
    exists: (filter: OrmfyFindFilter<DB, TName>, options?: {
        tx?: OrmfyDb<DB>;
    }) => Promise<boolean>;
    /**
     ...
     * ```
     */
    find: <TCount extends boolean = false>(filter?: OrmfyFindFilter<DB, TName>, options?: OrmfyFindOptions<DB, TName, TCount>) => Promise<OrmfyFindReturn<DB, TName, TCount>>;
    /** Busca um registro pela chave primaria. Retorna undefined quando nao encontrar. */
    findById: (id: OrmfyPrimaryKeyValue<DB, TName>, options?: {
        tx?: OrmfyDb<DB>;
    }) => Promise<OrmfyRow<DB, TName> | undefined>;
    /** Busca um registro pela chave primaria ou lanca erro quando nao encontrar. */
    findOrFail: (id: OrmfyPrimaryKeyValue<DB, TName>, options?: {
        tx?: OrmfyDb<DB>;
    }) => Promise<OrmfyRow<DB, TName>>;
    /** Busca o primeiro registro que bate com o filtro. */
    findOne: (filter: OrmfyFindFilter<DB, TName>, options?: {
        tx?: OrmfyDb<DB>;
    }) => Promise<OrmfyRow<DB, TName> | undefined>;
    ...
    firstOrCreate: (filter: OrmfyFindFilter<DB, TName>, data?: OrmfyCreateInput<DB, TName>, options?: {
        tx?: OrmfyDb<DB>;
    }) => Promise<OrmfyRow<DB, TName>>;
    /** Busca o primeiro registro que bate com o filtro ou lanca erro. */
    firstOrFail: (filter: OrmfyFindFilter<DB, TName>, options?: {
        tx?: OrmfyDb<DB>;
    }) => Promise<OrmfyRow<DB, TName>>;
    /** Incrementa uma coluna numerica por id e retorna o registro atualizado. */
    increment: (id: OrmfyPrimaryKeyValue<DB, TName>, column: OrmfyNumericColumn<DB, TName>, amount?: number, options?: {
        tx?: OrmfyDb<DB>;
    }) => Promise<OrmfyRow<DB, TName>>;
    /** Insere varios registros e retorna as linhas criadas. */
    insertMany: (data: readonly OrmfyCreateInput<DB, TName>[], options?: {
        tx?: OrmfyDb<DB>;
    }) => Promise<Array<OrmfyRow<DB, TName>>>;
    /**
    ...
    cursorPaginateSelect: <Columns extends readonly OrmfyColumn<DB, TName>[]>(columns: Columns, filter: OrmfyFindFilter<DB, TName> | undefined, options: OrmfyCursorPageOptions<DB, TName>) => Promise<OrmfyCursorPage<OrmfyProjection<DB, TName, Columns>>>;
    paginateSelect: <Columns extends readonly OrmfyColumn<DB, TName>[]>(columns: Columns, filter?: OrmfyFindFilter<DB, TName>, options?: OrmfyPageOptions<DB, TName>) => Promise<OrmfyPage<OrmfyProjection<DB, TName, Columns>>>;
    /** Retorna um array com os valores de uma coluna. */
    pluck: <Column extends OrmfyColumn<DB, TName>>(column: Column, filter?: OrmfyFindFilter<DB, TName>, options?: {
        tx?: OrmfyDb<DB>;
    ...
    select: <Columns extends readonly OrmfyColumn<DB, TName>[]>(columns: Columns, filter?: OrmfyFindFilter<DB, TName>, options?: OrmfyFindOptions<DB, TName, false>) => Promise<Array<OrmfyProjection<DB, TName, Columns>>>;
    selectOne: <Columns extends readonly OrmfyColumn<DB, TName>[]>(columns: Columns, filter?: OrmfyFindFilter<DB, TName>, options?: OrmfyFindOptions<DB, TName, false>) => Promise<OrmfyProjection<DB, TName, Columns> | undefined>;
    /**
     ...
     * Filtros vazios sao rejeitados, exceto quando `allowFullTableMutation` for true.
     */
    update: <Columns extends readonly OrmfyColumn<DB, TName>[] | undefined = undefined>(filter: OrmfyFindFilter<DB, TName>, data: OrmfyUpdateInput<DB, TName>, options?: OrmfyMutationReturningOptions<DB, TName, Columns>) => Promise<Array<OrmfyReturningRow<DB, TName, Columns>>>;
    /** Atualiza um registro pela chave primaria e retorna o registro atualizado. */
    updateById: <Columns extends readonly OrmfyColumn<DB, TName>[] | undefined = undefined>(id: OrmfyPrimaryKeyValue<DB, TName>, data: OrmfyUpdateInput<DB, TName>, options?: OrmfyReturningOptions<DB, TName, Columns>) => Promise<OrmfyReturningRow<DB, TName, Columns>>;
    /** Atualiza o primeiro registro encontrado ou cria um novo usando `filter + data`. */
    updateOrCreate: (filter: OrmfyFindFilter<DB, TName>, data: OrmfyCreateInput<DB, TName>, options?: {
        tx?: OrmfyDb<DB>;
    }) => Promise<OrmfyRow<DB, TName>>;
    /**
     ...
     * por acidente.
     */
    upsert: (data: readonly OrmfyCreateInput<DB, TName>[], onConflict: OrmfyColumn<DB, TName> | Array<OrmfyColumn<DB, TName>>, options: OrmfyUpsertOptions<DB, TName>) => Promise<Array<OrmfyRow<DB, TName>>>;
    /** Retorna o valor de uma coluna do primeiro registro encontrado. */
    value: <Column extends OrmfyColumn<DB, TName>>(column: Column, filter: OrmfyFindFilter<DB, TName>, options?: {
        tx?: OrmfyDb<DB>;
    }) => Promise<OrmfyRow<DB, TName>[Column] | undefined>;
    withTx: (tx: OrmfyDb<DB>) => OrmfyBase<DB, TName>;
};
export type Ormfy<DB, TName extends OrmfyTableName<DB>, CustomOps extends object> = Omit<OrmfyBase<DB, TName>, "tx" | "withTx"> & CustomOps & {
    tx: {
